    ...
    function sendRequest() {
      $.post("../controller/validator.php", $('#equations-form').serialize()).done(function (data) {
        ...
        if ((parseInt(attempt) > 3) || (result == <?php echo $equations_size; ?>)) {
          $("#send").remove();
          $("#equations-form").append('<p id="result">Calificaci贸n: ' + result + '/' + <?php echo $equations_size?> + '</p>');
        }
        displayResult(data);
      });
    }
    	...
    	$(function() {
             ...
             $("#sendie").keydown(function(event) {  
                 ...
                 if (key >= 33) {
                     ...
                     // No permitir seguir escribiendo si se lleg贸 al limite
                     if (length >= maxLength) {  
...
<div id="page-wrap" >
  ...
  <ul class="dropdown-menu" style="border-width: 0px"> <!-- aria-labelledby="dropdownMenu1" -->
    ...
    <li><a href="users.php"><Ubicaci锟絥</strong></a></span> <span class="menu-title"></a></li>
    <li><a href="#"></a></li>
...
<li class="dropdown">
  ...
  <ul class="dropdown-menu" style="border-width: 0px"> <!-- aria-labelledby="dropdownMenu1" -->
    <li><a href="../graph/php/views/grafica.php">Ver gr醘icas</a></li>
    <li><a href="#"></a></li>
  </ul>
</li>
...
';
  ...
  <ul class="dropdown-menu" style="border-width: 0px"> <!-- aria-labelledby="dropdownMenu1" -->
    ...
    <footer id="footer">
        ...
        <p class="pad-lft">漏 2015 Pizarra Virtual- UADY</p> -->
