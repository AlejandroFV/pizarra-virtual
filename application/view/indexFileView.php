        ...
        while($row = mysqli_fetch_array($files)){
            ...
            <form action="../controller/modifyFileController.php" method ="post">
                <tr>
                    ...
                    <td>
                        <input type="text" name="grupo" value="<?php echo $row['workgroup'] ?>"  <?php if($role == 'alumno'){echo "readonly";}?>/>
...
<!-- ESTO QUITE MEDIAFILE       <a href="addFileView.php">Subir mÃ¡s archivos</a><br><br>-->
