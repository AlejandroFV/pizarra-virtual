			...
			<div id="container" class="effect mainnav-lg navbar-fixed">
				...
				<div class="boxed">
					...
					<div id="content-container">
						...
						<h3>Ingrese la ecuaciÃ³n que desee evaluar junto con la respuesta correcta.</h3>

						<h4><small>Se pueden agregar posibles errores junto con mensajes hacÃ­a el usuario al cometerlos</small></h4>
